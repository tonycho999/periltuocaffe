        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            ...
            <textarea 
              ...
              placeholder="상세 정보를 입력하세요. HTML 태그 지원" 
      ...
      <div style={{ flex: '1', minWidth: '300px', padding: '25px', backgroundColor: '#f9f9f9', borderRadius: '12px', border: '1px solid #eee' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '15px', maxHeight: '550px', overflowY: 'auto', paddingRight: '5px' }}>
          ...
          {galleryImages.length === 0 && (
            <p style={{ textAlign: 'center', fontSize: '13px', color: '#999', padding: '30px 0' }}>업로드된 추가 이미지가 없습니다.</p>
          )}
        </div>
      </div>
...
const submitBtnStyle = (loading) => ({
  marginTop: '10px', padding: '15px', backgroundColor: loading ? '#ccc' : '#333', color: '#fff',
  border: 'none', borderRadius: '6px', cursor: loading ? 'default' : 'pointer', fontSize: '16px', fontWeight: 'bold', transition: '0.2s'
});
